        ...
        <div className="max-w-4xl mx-auto prose prose-lg">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              By accessing and using BitGrow Solution's services, you accept and agree to be bound by the
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              BitGrow Solution provides software development, consulting, and related technology services.
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              Unless otherwise agreed in writing, all deliverables created by BitGrow Solution remain our
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              BitGrow Solution shall not be liable for any indirect, incidental, special, consequential,
